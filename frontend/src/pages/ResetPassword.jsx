import { Alert, AlertIcon, Container, Flex, Spinner, VStack, Text, Link as ChakraLink, Center } from "@chakra-ui/react";
    ...
    return (
        <Flex minH='100vh' justify='center' mt={12}>
            <Container mx={"auto"} maxW={'md'} py={12} px={6} textAlign={'center'}>
                {
                    isLinkValid? <ResetPasswordForm code={code} />
                    : <VStack align={'center'} spacing={6}>
                        ...
                        Request a new password reset link</ChakraLink>
                    </VStack>
                }
            </Container>
        </Flex>
